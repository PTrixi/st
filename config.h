...
static char *font2[] = {	
			"JetBrainsMono NF:pixelsize=14:antialias=true:authoint=true",
			"FontAwesome:pixelsize=16:antialias=true:autohint=true",
			"Font Awesome 6 Brands Regular:pixelsize=16:antialias=true:autohint=true",
			"Font Awesome 6 Free Solid:pixelsize=16:antialias=true:autohint=true",
			"Font Awesome v4 Compatibility Regular:pixelsize=16:antialias=true:autohint=true",
			"Font Awesome 6 Free Regular:pixelsize=16:antialias=true:autohint=true",
			"Source Han Sans JP Normal:pixelsize=16:antialias=true:autohint=true",
